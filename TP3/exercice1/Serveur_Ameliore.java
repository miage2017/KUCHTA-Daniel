...
public class Serveur_Ameliore {
	...
	String[] listeNom = {"Spirigame", "DogiDogiDog", "zoanthr", "Orako", "Pride"};
	...
	public void run() {
		...
		while (true) {
			...
			ServiceClient serviceClient = new ServiceClient(ma_connection, ma_connection.getPort(), listeNom[compteur]);
	...
	public static void main(String[] args) throws IOException {
		...
		Mon_serveur = new Serveur_Ameliore(12000);
	/*	if (args.length != 1) {
